 ...
 */
void MGPIO_voidSetPinDirection(uint8 copy_u8PORT, uint8 copy_u8PIN, uint8 copy_u8Mode)
{
...
/**
 * @brief This Function is used to apply operations on all the port pins one time
 *
 * @param copy_u8PORT Refers to the port .. options(GPIOA, GPIOB, GPIOC)
 * @param copy_u8Value value that should be applied to the required port
 * @pre You should Call GPIO_voidSetPinDirection() in first
 *  
 */
void MGPIO_voidSetPortValue(uint8 copy_u8PORT,  uint16 copy_u8Value)
{
    /**Error Handling*/
    /*The port should be between A and C */
    if (copy_u8PORT > GPIOC)
 ...
 */
uint8 MGPIO_voidGetPinValue(uint8 copy_u8PORT, uint8 copy_u8PIN)
{
    /*Variable to return*/
 ...
 */
void MGPIO_voidLockByPinNum(uint8 copy_u8PORT, uint8 copy_u8PIN)
{
    /*Error Handling*/
    /*The port should be between A and C */
    if (copy_u8PORT > GPIOC)
 ...
 */
void MGPIO_voidLockByPortMask(uint8 copy_u8PORT, uint32 copy_u8PortMask)
{
    /*Error Handling*/
    /*The port should be between A and C */
    if (copy_u8PORT > GPIOC)
